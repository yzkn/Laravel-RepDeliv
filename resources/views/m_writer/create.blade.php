                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="panel panel-default">
                            <div class="panel-heading">Create New m_writer</div>
                            <div class="panel-body">
                                ...
                                <form method="POST" action="/m_writer/store" class="form-horizontal">
                                    {{ csrf_field() }}
                                        ...
                                        <div class="col-md-6">
                                            <input class="form-control" name="id_m_writer_roles" type="text" id="id_m_writer_roles" value="{{old('id_m_writer_roles')}}">
                                        </div>
                                    </div>
